...
XML_INPUT_DIR = INTERMEDIATE_XML_DIR

# ==================================================
# OUTPUT DIRECTORIES
# ==================================================
INTERMEDIATE_LIBRARY_OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
# ==================================================
# VALIDATION 
# ==================================================
...
print("Library output dir:", INTERMEDIATE_LIBRARY_OUTPUT_DIR)
...
command = [
    ...
    "-lib=" + str(
    INTERMEDIATE_LIBRARY_OUTPUT_DIR
    / f"NISTL{RUN_YEAR}_Intermediate_Library.lib"
)
